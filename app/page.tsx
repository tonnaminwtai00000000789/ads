    ...
    <div className="relative min-h-screen w-full flex items-center justify-center bg-zinc-950 overflow-hidden text-zinc-50 font-sans selection:bg-[#d4a76a]/30">
      ...
      <section className="relative z-10 w-full max-w-md px-4 py-8 flex flex-col items-center gap-12">
        ...
        <main className="flex flex-col items-center w-full">
          <Button
            onClick={login}
            className="bg-[#5865F2] hover:bg-[#4752C4] transition-all duration-300 ease-in-out px-10 py-7 text-white font-semibold text-xl rounded-2xl shadow-xl shadow-[#5865F2]/20 active:scale-95 flex items-center gap-3 cursor-pointer group"
          >
            <svg
              width="28"
              height="28"
        ...
        <footer className="mt-6 flex justify-center items-center gap-2 text-xs">
          ...
          <span className="text-zinc-600">&copy; 2025</span>
        </footer>
      </section>
    </div>
  );
