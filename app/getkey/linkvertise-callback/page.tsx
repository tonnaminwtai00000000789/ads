// app/linkvertise-callback/page.tsx (Next.js App Router)
// หรือ pages/linkvertise-callback.tsx (Pages Router)
...
export default function LinkvertiseCallback() {
        ...
        const processCallback = async () => {
            ...
            try {
                ...
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/api/genkey`,
                    {
                        method: 'POST',
                        credentials: 'include',
                        headers: {
                        ...
                        body: JSON.stringify({ token, hash, discord_id }),
                    }
                );
